...
def main(args):
    ...
    try:
        ...
        training_ht = hl.read_table(po_coverage_ht_path)
        training_x_ht = hl.read_table(po_coverage_ht_path.replace(".ht", "_x.ht"))
        training_y_ht = hl.read_table(po_coverage_ht_path.replace(".ht", "_y.ht"))
