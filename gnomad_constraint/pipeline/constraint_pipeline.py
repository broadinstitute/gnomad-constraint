    ...
    try:
        ...
        if args.apply_models:
            ...
            for r in regions:
                ...
                oe_ht.write("gs://gnomad-kristen/constraint/apply_with_rank.ht", overwrite=overwrite)
            logger.info(
        ...
        if args.compute_constraint_metrics:
            ...
            union_ht = hl.read_table("gs://gnomad-kristen/constraint/apply_with_rank.ht")
            ...
            compute_constraint_metrics(
                ...
                "gs://gnomad-kristen/constraint/metrics_with_rank.ht", overwrite=overwrite
        ...
        if args.export_tsv:
            ...
            ht = hl.read_table("gs://gnomad-kristen/constraint/metrics_with_rank.ht")
            ht = ht.flatten()
            #ht.export(res.constraint_metrics_tsv)
            ht.export("gs://gnomad-kristen/constraint/metrics_with_rank.tsv")
