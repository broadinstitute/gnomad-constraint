    ...
    try:
        ...
        if args.apply_models:
            ...
            for r in regions:
                ...
                oe_ht.write(
                    "gs://gnomad-kristen/constraint/drop_cov/apply_models.ht",
                    overwrite=overwrite,
                )
            logger.info(
        ...
        if args.compute_constraint_metrics:
            ...
            compute_constraint_metrics(
                ...
                "gs://gnomad-kristen/constraint/drop_cov/drop_cov_constraint_metrics.ht",
                overwrite=overwrite,
            )
        ...
        if args.export_tsv:
            ...
            ht = ht.flatten()
            ht.export(
                "gs://gnomad-kristen/constraint/drop_cov/drop_cov_constraint_metrics.tsv"
            )
