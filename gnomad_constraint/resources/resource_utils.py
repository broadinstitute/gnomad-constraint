...
def get_constraint_root(version: str = CURRENT_VERSION, test: bool = False) -> str:
    ...
    return f"gs://gnomad/v{version}/constraint_alphamissense"
...
def get_preprocessed_ht(
    ...
    check_param_scope(version)
    return TableResource(
        f"{get_constraint_root(version, test)}/preprocessed_data/gnomad.v{version}.context.preprocessed.ht"
    )
...
def get_training_dataset(
    ...
    check_param_scope(version)
    return TableResource(
        f"{get_constraint_root(version, test)}/training_data/gnomad.v{version}.constraint_training.ht"
    )
...
def get_training_tsv_path(
    ...
    return f"{get_constraint_root(version, test)}/training_data/gnomad.v{version}.constraint_training.tsv.bgz"
...
def get_models(
    ...
    return ExpressionResource(
        f"{get_constraint_root(version, test)}/models/gnomad.v{version}.{model_type}.he"
    )
...
def get_predicted_proportion_observed_dataset(
    ...
    return TableResource(
        f"{get_constraint_root(version, test)}/predicted_proportion_observed/{custom_vep_annotation}/gnomad.v{version}.predicted_proportion_observed.ht"
    )
